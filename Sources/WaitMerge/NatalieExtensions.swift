...
extension Double {
    ...
    /**
     Round a double to specific decimal places.
     ## Chinese description
     四捨五入至小數位第x位
    ...
    /**
     Chop off a double to specific decimal places.
     ...
     ```
     let num = 6.445677
     num.chopOff(to: 2) // get 6.44
     ```
     */
    func chopOff(to places: Int) -> Double {
        let divisor = pow(10.0, Double(places))
